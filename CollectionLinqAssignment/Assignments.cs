...
namespace CollectionLinqAssignment
{
    public static class Assignments
    {
        ...
        public static List<string> FindStringsStartingWithA(List<string> strings)
        {
            ...
            var startingWithA = strings.Where(x => x.StartsWith('A')).ToList();
        ...
        public static Dictionary<string, int> FindCitiesWithPopulationOverOneMillion(Dictionary<string, int> cities)
        {
            ...
            var citiesOverOneMillion = cities.Where(x => x.Value > 1000000).ToDictionary(x => x.Key, x => x.Value);
        ...
        public static List<Product> FilterElectronicsUnder100(List<Product> products)
        {
            ...
            var electronicsUnder100 = products.Where(x => x.Category == "Electronics")
                                              .Where(x => x.Price < 100).ToList();
        ...
        public static List<object> ProjectFullNameAndIsAdult(List<Person> people)
        {
            ...
            var fullnameAndIsAdult = people.Select(x => new
            {
        ...
        public static Dictionary<int, decimal> TotalAmountSoldPerProduct(List<Sale> sales)
        {
            ...
            var totalPerProduct = sales.GroupBy(x => x.ProductId)
                                       .ToDictionary(x => x.Key, y => y.Sum(x => x.AmountSold));
        ...
        public static List<Student> TopStudentFromEachGrade(List<Student> students)
        {
            ...
            var topStudentPerGrade = students.GroupBy(x => x.GradeLevel)
                                             .Select(g => g.OrderByDescending(y => y.GPA))
                                             .Select(x => x.First())
                                             .ToList();

            return topStudentPerGrade;
        }
        ...
        public static Dictionary<string, Student> FindTopPerformersInEachSubject(List<School> schools)
        {
            ...
            var topInEachSubject = schools.SelectMany(x => x.Students)
                                          .SelectMany(x => x.Subject.Select(y => new { x, y })
                                          .Select(z => new
                                          {
                                              Student = z.x,
                                              Subject = z.y.Name,
                                          ...
                                          .Select(x => x.First())
                                          .ToDictionary(x => x.Subject, x => x.Student);


            return topInEachSubject;
        }
